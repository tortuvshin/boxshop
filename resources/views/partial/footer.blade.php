...
Манай салон нь өдөр тутмын, гоёлын, хуримын, express будалтууд хийнэ. </span> </ul>
        ...
        <div class="col-xs-4 col-sm-4 col-md-4 enu">
            <h3 class="widget-title heading-title">Instagram posts</h3>
            <div class="line line-30"></div>

            <blockquote class="instagram-media" data-instgrm-version="7" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:658px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);"><div style="padding:8px;"> <div style=" background:#F8F8F8; line-height:0; margin-top:40px; padding:50.0% 0; text-align:center; width:100%;"> <div style=" background:url(data:image/png;base64,); display:block; height:44px; margin:0 auto -44px; position:relative; top:-22px; width:44px;"></div></div><p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;"><a href="https://www.instagram.com/p/BK4W_zfA-rt/" style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank">A photo posted by Bella Make Up Salon Official (@isabellabellasmakeup)</a> on <time style=" font-family:Arial,sans-serif; font-size:14px; line-height:17px;" datetime="2016-09-28T01:08:36+00:00">Sep 27, 2016 at 6:08pm PDT</time></p></div></blockquote> <script async defer src="//platform.instagram.com/en_US/embeds.js"></script>
    ...
    <div class="fourth-footer-area row ">
        ...
        <div id="copy-right" class="copy-right col-sm-12">
            ...
            <div class="payment col-sm-4">
                <ul>
                    <li>
                        <a href="#"><img src="img/paypal/paypal.jpg">
                        </a>
                    </li>
                    <li>
                        <a href="#"><img src="img/paypal/mastercard.jpg">
                        </a>
                    </li>
                    <li>
                        <a href="#"><img src="img/paypal/american.jpg">
                        </a>
                    </li>
                    <li>
                        <a href="#"><img src="img/paypal/visa.jpg">
                        </a>
                    </li>
                </ul>
            </div>
